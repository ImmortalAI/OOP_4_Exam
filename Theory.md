...
Самым простым примером CPU Bound задачи может быть вычисление n-ого большого числа Фибоначчи или определение n-ого количества цифр числа Пи, так как с каждым увеличением числа n увеличивается нагрузка на процессор для расчета.
...
32.	 Реализации DI при разработке Web сервисов. Жизненный цикл зависимостей (.AddScoped, .AddSingletone, .AddTransient). 



33.	Технологии контроля изменений в коде на примере Git. Основные понятия (branch, merge, commit, pull\push, chery pick)
